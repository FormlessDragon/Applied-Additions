...
public abstract class AAEAbstractCraftingUnitBlock<T extends AdvCraftingBlockEntity> extends AEBaseTileBlock<T> {
    ...
    protected AAEAbstractCraftingUnitBlock(ICraftingUnitType type, Class<T> tileEntityClass) {
        super(Material.IRON);
        this.type = type;
    ...
    private boolean isConnected(IBlockAccess world, BlockPos pos, EnumFacing side) {
        return world.getBlockState(pos.offset(side)).getBlock() instanceof AAEAbstractCraftingUnitBlock<?>;
    }
